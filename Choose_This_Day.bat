...
echo.
echo.
echo                .d8888b.  888                                                 88888888888 888      d8b
echo               d88P  Y88b 888                                                     888     888      Y8P
echo               888    888 888                                                     888     888
echo               888        88888b.   .d88b.   .d88b.  .d8888b   .d88b.             888     88888b.  888 .d8888b
echo               888        888 "88b d88""88b d88""88b 88K      d8P  Y8b            888     888 "88b 888 88K
echo               888    888 888  888 888  888 888  888 "Y8888b. 88888888            888     888  888 888 "Y8888b.
echo               Y88b  d88P 888  888 Y88..88P Y88..88P      X88 Y8b.                888     888  888 888      X88
echo                "Y8888P"  888  888  "Y88P"   "Y88P"   88888P'  "Y8888             888     888  888 888  88888P'
echo.
echo.
echo                                            8888888b.
echo                                            888  "Y88b
echo                                            888    888
echo                                            888    888  8888b.  888  888
echo                                            888    888     "88b 888  888
echo                                            888    888 .d888888 888  888
echo                                            888  .d88P 888  888 Y88b 888
echo                                            8888888P"  "Y888888  "Y88888
echo                                                                   888
echo                                                              Y8b d88P
echo                                                               "Y88P"
echo.
...
timeout /t 4 >nul
cls
call :say "You have ten seconds." 1
timeout /t 1 >nul
call :say "Press C if you wish to stay." 1

choice /c CY /t 10 /d Y >nul

if errorlevel 2 goto shutdown_now
goto cancelled
...
timeout /t 1 >nul
 call :say "Maybe you pressed C without thinking." 1
    ...
    call :say "you would take them." 1
    timeout /t 3 >nul

    call :say "So why give away entire days?" 1
    timeout /t 4 >nul

    call :say "Why keep saying..." 1
    timeout /t 2 >nul

    call :say "tomorrow." 1
    timeout /t 4 >nul

    call :say "One day there won't be a tomorrow for any of us." 1
    timeout /t 4 >nul

    call :say "But today is still here." 1
    timeout /t 3 >nul
...
shutdown /s /t 3 /c "The rest is up to you."
exit /b
